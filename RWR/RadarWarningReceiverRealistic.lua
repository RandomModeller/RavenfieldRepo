behaviour("RadarWarningReceiverRealistic") --v1.1.0
        ...
        for i, blip in pairs(self.blips) do
            ...
            if missile ~= nil then
                ...
                if flag1 then
                    ...
                    local missileAbove = missilePos.y >= normalVehiclePos.y
                    blip.missileAbove = missileAbove
                    blip.missileBelow = not missileAbove
