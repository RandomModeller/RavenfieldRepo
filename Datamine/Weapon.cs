...
public class Weapon : MonoBehaviour {
	...
	public SoundBank playerFireSound;

	public float fireSoundDelay;

	public Weapon.AudioMode audioMode;

	[ConditionalField("audioMode", new object[] {
		Weapon.AudioMode.Looped
	}, invert = true)]
	...
	public class Configuration {
		...
		public Weapon.LowAmmoFeedback lowAmmoFeedback;
		public float outOfAmmoVolume = 0.3f;
		public float outOfAmmoExtraPitch = 0.2f;
